...
public class TestActivity extends AppCompatActivity {
    ...
    private void createAccount() {
        ...
        if (TextUtils.isEmpty(email)||TextUtils.isEmpty(password)) {
            Toast.makeText(TestActivity.this, "Fields are empty.", Toast.LENGTH_LONG).show();
            return;
        }
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(TestActivity.this, "Registered Successfully.", Toast.LENGTH_LONG).show();
                    Intent intent2 = new Intent(TestActivity.this,  AccountActitivity.class);
                    String username;
                    ...
                    Toast.makeText(TestActivity.this, "Registered failed, please try again.....", Toast.LENGTH_LONG).show();
                }
